...
function ENT:Faction_CustomOnInitialize()
	...
	self.SoundTbl_BecomeEnemyToPlayer = {"vj_hlr/czeror_npc/ct/ct_okthatis_fr.wav","vj_hlr/czeror_npc/ct/ct_gottrait_fr.wav","vj_hlr/czeror_npc/ct/ct_gonero_fr.wav","vj_hlr/czeror_npc/ct/ct_ceasef_fr.wav"}
	self.SoundTbl_Suppressing = {"vj_hlr/czeror_npc/ct/ct_firing4_fr.wav"}
	...
	self.SoundTbl_DamageByPlayer = {"vj_hlr/czeror_npc/ct/ct_holdfire2_fr.wav","vj_hlr/czeror_npc/ct/ct_checkfire_fr.wav"}
